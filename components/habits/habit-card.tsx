...
export function HabitCard({ habit }: HabitProps) {
  ...
  const handleSnooze = () => {
    setIsRinging(false)
    toast.info(`Snoozed ${habit.title} for 10 minutes`)
  ...
  return (
    <>
      ...
      <div className={cn(
        "flex items-center justify-between p-5 border rounded-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-md",
        ...
        <div className="flex items-center gap-1">
          {/* Focus Timer Button */}
          <FocusTimer habitTitle={habit.title} />
