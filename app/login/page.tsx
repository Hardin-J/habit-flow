...
export default function LoginPage() {
    return (
        <div className="flex min-h-screen flex-col items-center justify-center relative overflow-hidden bg-background text-foreground">
            {/* Background Effects */}
            ...
            <div className="w-full max-w-md space-y-8 rounded-2xl bg-card/50 p-8 shadow-2xl backdrop-blur-xl border ring-1 ring-black/5 dark:ring-white/10 relative">
                ...
                <div className="flex flex-col items-center space-y-2 text-center pt-4">
                    <div className="rounded-full bg-orange-100 dark:bg-orange-900/20 p-3 text-orange-600">
                ...
                <div className="space-y-4 pt-4">
                    ...
                    >
                        <Button variant="outline" className="w-full py-6 text-base font-medium transition-all hover:bg-accent hover:text-accent-foreground" type="submit">
